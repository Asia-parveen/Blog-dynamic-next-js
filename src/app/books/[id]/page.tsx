    ...
    <div className="p-8 max-w-4xl mx-auto ">
     ...
     <p className="text-lg text-gray-800 mb-4">
      ...
      <p className="text-gray-700 leading-relaxed mb-6">
        <span className="font-semibold text-gray-800">Description:</span> {book.description}</p>
     </div>
...
//   return (
//     <div className="p-8 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
//       {/* Book Image */}
//       <div className="image-container rounded-lg h-[100vh] overflow-hidden p-2">
//         <Image
//           src={book.image}
//           alt={book.title}
//           width={800}
//           height={0} // Set height to 0 so it's responsive, using vh for height
//           className="w-full h-[50vh] object-cover rounded mb-6 transition-transform transform duration-300 hover:opacity-60"
//         />
//       </div>
