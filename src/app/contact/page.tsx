...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-100 to-gray-200 py-12">
      ...
      "Get in touch with us to share your thoughts, ask questions, or explore collaborations.<br></br> We're here to connect and discuss the world of books and beyond!"
      </p>
      </div>
